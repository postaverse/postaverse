        ...
        <div class="col-span-6 sm:col-span-4 mt-4">
            <div class="p-4 bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-lg">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-blue-400" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <p class="text-sm text-blue-300">For better security, use a password that is at least 8 characters
                        long with a mix of letters, numbers, and symbols.</p>
                </div>
            </div>
        </div>
    </x-slot>
