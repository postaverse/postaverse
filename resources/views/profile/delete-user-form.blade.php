    ...
    <x-slot name="content">
        <div class="p-4 bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-lg text-sm text-gray-300 mb-4">
            <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-red-400 shrink-0 mt-0.5" fill="none"
        ...
        <x-dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="footer">
                ...
                <x-danger-button class="ml-3 bg-red-600 hover:bg-red-700 transition-colors" wire:click="deleteUser"
