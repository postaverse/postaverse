                        ...
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                <select 
                                    ...
                                    class="block w-full pl-3 pr-10 py-2 text-base border-gray-600 bg-gray-800/60 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                >
