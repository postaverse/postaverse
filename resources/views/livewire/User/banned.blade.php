<div class="min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <!-- Main Ban Notice -->
        <div class="bg-gradient-to-br from-red-900/40 to-red-800/30 backdrop-blur-xl border border-red-500/30 rounded-2xl shadow-2xl overflow-hidden">
            <!-- Header -->
        ...
        <div class="text-center mt-6">
            <p class="text-gray-400 text-sm">
                ...
                <a href="{{ route('terms.show') }}" class="text-indigo-400 hover:text-indigo-300 transition-colors">Community Guidelines</a>
            </p>
        </div>
    </div>
</div>
