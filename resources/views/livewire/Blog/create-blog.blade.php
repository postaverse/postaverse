<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6" x-data="{ title: '', content: '' }">
    <div
        ...
        <h2 class="text-2xl font-bold text-white mb-6">Create a New Blog Post</h2>
        <form wire:submit.prevent="submit">
            <div class="mb-4">
                ...
                <x-input id="title" type="text"
                    ...
                    wire:model="title" x-model="title" placeholder="Enter your blog title..." />
                <div :class="{ 'text-red-500': title.length > 255, 'text-gray-500': title.length <= 255 }"
                    class="mt-1 text-sm">
            ...
            <div class="mb-6">
                ...
                <x-textarea id="content"
                    class="mt-1 block w-full h-64 bg-gray-800/40 backdrop-blur-sm border border-white/10 text-white focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition-all"
                    wire:model="content" x-model="content"
                    placeholder="Write your blog post content here..."></x-textarea>
            ...
            <div class="mb-6">
                ...
                <div class="mt-1">
                    <label
                        class="flex justify-center items-center px-4 py-6 bg-gray-800/40 backdrop-blur-sm border border-dashed border-white/20 rounded-lg cursor-pointer hover:border-indigo-500/50 transition-all">
                        ...
                        @foreach ($photos as $photo)
                            <div class="relative group">
                                ...
                                <div
                                    ...
                                    <button type="button" onclick="removePhoto({{ $loop->index }})"
            ...
            <div class="flex justify-between items-center">
                <x-button type="submit" class="bg-indigo-600 hover:bg-indigo-700 transition-colors">
                    <img src="{{ asset('images/icons/blastoff.png') }}" alt="Submit" width="30" height="30"
                        class="p-1 pr-2">
                    {{ __('Publish Blog') }}
                </x-button>
