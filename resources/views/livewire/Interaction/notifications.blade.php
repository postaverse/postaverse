<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                @if (!$notifications->isEmpty())
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                <x-select wire:model.live="bulkActionType" class="pl-3 pr-10 py-2 text-base">
                            ...
                            <button wire:click="executeBulkAction" @if (empty($selectedNotifications) || empty($bulkActionType)) disabled @endif
            ...
            @if ($notifications->isEmpty())
                <div
                    class="bg-linear-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl border border-white/10 overflow-hidden shadow-lg sm:rounded-xl p-8 text-center">
            ...
            @else
                <!-- Select All Row -->
                <div
                    class="flex items-center p-4 mb-4 bg-gray-800/40 backdrop-blur-sm rounded-lg border border-white/10">
                ...
                <div class="space-y-4">
                    @foreach ($notifications as $notification)
                        <div
                            class="flex bg-linear-to-br {{ !$notification->read_at ? 'from-indigo-900/20 to-gray-800/60 border-indigo-500/30' : 'from-gray-900/80 to-gray-800/60 border-white/10' }} backdrop-blur-xl border overflow-hidden shadow-lg sm:rounded-xl p-4 transition-colors hover:border-white/20">
                            <!-- Checkbox -->
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex space-x-4 mt-2">
                                                <a href="{{ $notification->link }}"
                                                    class="text-indigo-400 hover:text-indigo-300 transition-colors text-sm">
                                                    View
                                                </a>
                                    ...
                                    <div class="hidden sm:block">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $notification->read_at ? 'bg-gray-700 text-gray-400' : 'bg-indigo-800 text-indigo-100' }}">
