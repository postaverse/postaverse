    ...
    <div class="bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-4">
        <form wire:submit.prevent="submit">
            <div class="mb-4">
                ...
                <div :class="{'text-red-500': title.length > 255, 'text-gray-600': title.length <= 255}" class="mt-1 text-sm">
            ...
            <div class="mb-4">
                ...
                <div :class="{'text-red-500': content.length > 999999999, 'text-gray-600': content.length <= 999999999}" class="mt-1 text-sm">
