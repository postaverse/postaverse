<x-form-section submit="verify">
    ...
    <x-slot name="form">
        ...
        @if ($site && $site->is_verified)
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex items-center">
                    <x-input id="verified_domain" type="text" class="mt-1 block w-full bg-gray-800/40 backdrop-blur-sm border border-white/10 text-white" value="{{ $site->domain }}"
                        readonly />
        ...
        @else
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="domain" type="text" class="mt-1 block w-full bg-gray-800/40 backdrop-blur-sm border border-white/10 text-white focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition-all" wire:model="domain" required
                    autocomplete="domain" placeholder="example.com" />
        ...
        @if (!($site && $site->is_verified))
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-1 p-3 rounded-lg border
                    @if ($site && $site->is_verified)
                        bg-green-500/10 border-green-500/20 text-green-300
                    @else
                        bg-gray-800/40 backdrop-blur-sm border-white/10 text-gray-400
                    @endif
                ">
                    <div class="flex items-center">
                        @if ($site && $site->is_verified)
            ...
            <div class="col-span-6 sm:col-span-4 mt-2">
                ...
                <div class="mt-1 p-4 bg-gray-800/40 backdrop-blur-sm border border-white/10 rounded-lg">
                    <ol class="list-decimal list-inside space-y-3 text-gray-300">
                        <li>Add the following meta tag to your website's <code class="text-indigo-300">&lt;head&gt;</code> section:</li>
                        <div class="bg-gray-900/80 p-3 rounded-lg border border-indigo-500/20 mt-2 mb-3 overflow-x-auto">
                            <code class="text-indigo-300 text-sm" style="word-break: break-all;">&lt;meta name="postaverse-web-verification" content="{{ $verificationCode }}"&gt;</code>
                        </div>
        ...
        @if ($site && $site->is_verified)
            ...
            <div class="col-span-6 sm:col-span-4 mt-4">
                ...
                <p class="text-xs text-gray-400 mt-2">Removing your verified website will remove the verification badge from your profile.</p>
            </div>
        @endif
    </x-slot>
    ...
    <x-slot name="actions">
        ...
        @if (!($site && $site->is_verified))
            <x-button wire:loading.attr="disabled" wire:target="verify" class="bg-indigo-600 hover:bg-indigo-700 transition-colors">
                {{ __('Verify Website') }}
            </x-button>
        @endif
    </x-slot>
