<x-form-section submit="verify">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="verified_domain" type="text" class="mt-1 block w-full" value="{{ $site->domain }}" readonly />
        </div>
        @else
        <div class="col-span-6 sm:col-span-4">
            <x-label for="domain" value="{{ __('Domain') }}" />
            <x-input id="domain" type="text" class="mt-1 block w-full" wire:model="domain" required autocomplete="domain" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="is_verified" type="text" class="mt-1 block w-full" value="{{ $site ? ($site->is_verified ? 'Verified' : 'Not Verified') : 'No Site Found' }}" readonly />
