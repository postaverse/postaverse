<div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Profile Header Card -->
            <div class="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl border border-white/10 overflow-hidden shadow-lg sm:rounded-xl mb-8 hover:border-white/20 transition-all duration-300">
                <div class="p-8">
            ...
            <div class="mb-8">
                ...
                @if ($posts->isEmpty())
                    <div class="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl border border-white/10 overflow-hidden shadow-lg sm:rounded-xl p-8 hover:border-white/20 transition-all duration-300 text-center">
