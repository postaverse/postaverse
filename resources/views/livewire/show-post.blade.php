<div class="max-w-2xl mx-auto p-6">
    ...
    <div class="mb-6">
        <button 
            ...
            class="flex items-center space-x-2 text-zinc-400 hover:text-zinc-300 transition-colors"
        >
                        ...
                        <div class="mt-3">
                            @if(count($post->sharedPost->media_urls) === 1)
                                <img 
                                    ...
                                    onclick="openImageModal('{{ $post->sharedPost->getImageUrl($post->sharedPost->media_urls[0]) }}')"
                                >
                            @else
                                        ...
                                        @if($index < 4)
                                            <div class="relative">
                                                <img 
                                                    ...
                                                    onclick="openImageModal('{{ $post->sharedPost->getImageUrl($media) }}')"
                                                >
            ...
            <div class="px-6 pb-4">
                ...
                @if(count($mediaUrls) === 1)
                    <img 
                        ...
                        alt="Post media" 
                        class="w-full rounded-lg max-h-96 object-cover cursor-pointer"
                        onclick="openImageModal('{{ $mediaUrls[0] }}')"
                    >
                @else
