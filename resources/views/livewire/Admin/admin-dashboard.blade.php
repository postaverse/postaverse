                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model.debounce.100ms="searchTerm" type="text"
                                    class="border-white/20 bg-gray-800/10 backdrop-blur-sm text-gray-300 pl-10 focus:border-white/30 focus:ring-indigo-600 rounded-md shadow-sm"
