...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen">
        ...
        <!-- Page Heading -->
        @if (isset($header))
            <header class="bg-gray-800/10 backdrop-blur-sm border-b border-white/20 shadow header"
                style="position: relative !important; z-index: 9999 !important;">
        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <p class="text-sm text-gray-400">&copy; {{ date('Y') }} {{ config('app.name') }}. All rights
                        reserved.</p>
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <a href="/@1" class="text-sm text-gray-400 hover:text-white transition">Zander Lewis -
                        Development</a>
                    <a href="/@2" class="text-sm text-gray-400 hover:text-white transition">Liv - Mascot
                        Creation</a>
                    <a href="/@3" class="text-sm text-gray-400 hover:text-white transition">Calvare - Outro
                        Creation</a>
                </div>
            </div>
        </div>
