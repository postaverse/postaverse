@props(['bannedSearchResults'])

<div>
    <label class="block text-sm font-medium text-gray-300 mb-2">Search Banned User</label>
    <div class="relative">
        <input type="text" wire:model.live.debounce.300ms="unban_user_search"
        ...
        @if (strlen($this->unban_user_search ?? '') > 0)
            ...
            @else
                <div class="p-4 text-center">
                    <div class="text-gray-400">
                        ...
                        <p>No banned users found matching "{{ $this->unban_user_search }}"</p>
                    </div>
                </div>
            @endif
        </div>
