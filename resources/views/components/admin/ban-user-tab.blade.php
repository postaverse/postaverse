@props(['            <div class="bg-red-500/20 rounded-lg p-3 mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <circle cx="12" cy="12" r="10"/>
                    <path d="m4.9 4.9 14.2 14.2"/>
                </svg>
            </div>Results', 'selectedUser'])
    ...
    <div class="bg-linear-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl border border-white/10 overflow-hidden shadow-lg sm:rounded-xl p-6 hover:border-white/20 transition-all duration-300">
        ...
        <div class="space-y-6">
            ...
            <x-admin.action-buttons 
                ...
                confirmAction="confirmBanUser"
                confirmText="Ban User"
                confirmLoadingText="Banning..."
                confirmColor="red"
                iconType="ban"
                :disabled="!$selectedUser || !isset($reason)" />
        </div>
    </div>
</div>
