@props(['align' => 'right', 'width' => '48', 'contentClasses' => 'py-1 bg-gray-800/10 backdrop-blur-sm border border-white/20', 'dropdownClasses' => ''])
...
<div x-data="{ open: false, top: 0, left: 0, width: 0 }" 
