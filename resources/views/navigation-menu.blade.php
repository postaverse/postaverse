                                ...
                                <x-dropdown align="right" width="60">
                                    <x-slot name="trigger">
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-gray-800 hover:text-gray-300 focus:outline-none dark:focus:bg-gray-700 :active:bg-gray-700 transition ease-in-out duration-150">
                            ...
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    ...
                                    @else
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md dark:text-gray-400 dark:bg-gray-800 dark:hover:text-gray-300 focus:outline-none dark:focus:bg-gray-700 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                                {{ Auth::user()->name }}
        ...
        @else
            <nav class="bg-gray-800 border-b border-gray-700">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <!-- Home Link -->
                                <x-nav-link href="{{ route('unauthenticated-home') }}" :active="request()->routeIs('home')"
                                    class="flex flex-col items-center">
                                    <img src="{{ asset('images/home.png') }}" alt="Home" class="w-9 h-9">
                                    <span>{{ __('Home') }}</span>
                                </x-nav-link>
                                ...
                                <x-nav-link href="{{ route('login') }}" :active="request()->routeIs('login')"
                                    class="flex flex-col items-center">
                                    <img src="{{ asset('images/login.png') }}" alt="Login" class="w-9 h-9">
                                    <span>{{ __('Login') }}</span>
                                </x-nav-link>
                                <!-- Register Link -->
                                <x-nav-link href="{{ route('register') }}" :active="request()->routeIs('register')"
                                    class="flex flex-col items-center">
                                    <img src="{{ asset('images/register.png') }}" alt="Register" class="w-9 h-9">
                ...
                <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <!-- Home Link -->
                        <x-responsive-nav-link href="{{ route('unauthenticated-home') }}" :active="request()->routeIs('home')"
                            class="flex items-center space-x-2">
                            <img src="{{ asset('images/home.png') }}" alt="Home" class="w-10 h-10">
                            <span>{{ __('Home') }}</span>
                        </x-responsive-nav-link>
                        ...
                        <x-responsive-nav-link href="{{ route('login') }}" :active="request()->routeIs('login')"
                            class="flex items-center space-x-2">
                            <img src="{{ asset('images/login.png') }}" alt="Login" class="w-10 h-10">
                            <span>{{ __('Login') }}</span>
                        </x-responsive-nav-link>
                        <!-- Register Link -->
                        <x-responsive-nav-link href="{{ route('register') }}" :active="request()->routeIs('register')"
                            class="flex items-center space-x-2">
                            <img src="{{ asset('images/register.png') }}" alt="Register" class="w-10 h-10">
                            <span>{{ __('Register') }}</span>
                        </x-responsive-nav-link>
                    </div>
                </div>
